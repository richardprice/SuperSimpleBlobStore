...
namespace Nancy
{
    ...
    /// </summary>
    public class CustomNancyBootstrapper : NancyBootstrapperWithRequestContainerBase<TinyIoCContainer>
    {
        private readonly TinyIoCContainer _ioCContainer;

        public CustomNancyBootstrapper(TinyIoCContainer ioCContainer)
        {
        ...
        {
            // Do nothing as we already run auto registration with customisation elsewhere
        }
